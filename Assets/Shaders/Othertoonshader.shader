	...
	Tags{ "LightMode" = "ForwardBase" }
        // pass for ambient light and first light source
      	...
      	vertexOutput vert(vertexInput input)
      	{
      		...
      		//normalDirection
      		output.normalDir = normalize ( mul( float4( input.normal, 1.0 ), _World2Object).xyz);
      		...
      		//light direction
      		float3 fragmentToLightSource = (1.0 - posWorld.w);
      		output.lightDir = float4(
      			normalize( lerp(_WorldSpaceLightPos0.xyz , fragmentToLightSource, _WorldSpaceLightPos0.xyz) ),
